...
/*The restaurant class is used to show a list of restaurants nearby*/
public class Restaurant extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            ...
            hotelName = (TextView) findViewById(R.id.restName);
            tags = (TextView) findViewById(R.id.tags);
            address = (TextView) findViewById(R.id.address);
            hotelImage = (ImageView) findViewById(R.id.restImage);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.action_viewProfile:
                ...
                Intent intent2 = new Intent(Restaurant.this, Profile.class);
